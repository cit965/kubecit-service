...
func wireApp(confServer *conf.Server, confData *conf.Data, logger log.Logger) (*kratos.App, func(), error) {
	...
	userAggregateRepo := data.NewUserAggregateRepo(dataData, logger)
	userUsecase := biz.NewUserUsecase(accountRepo, userRepo, userAggregateRepo, logger)
	kubecitService := service.NewKubecitService(courseUsecase, systemUsecase, userUsecase)
