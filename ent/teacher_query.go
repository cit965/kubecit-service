...
func (tq *TeacherQuery) loadCourses(ctx context.Context, query *CourseQuery, nodes []*Teacher, init func(*Teacher), assign func(*Teacher, *Course)) error {
...
func (tq *TeacherQuery) ForUpdate(opts ...sql.LockOption) *TeacherQuery {
...
func (tq *TeacherQuery) ForShare(opts ...sql.LockOption) *TeacherQuery {
	if tq.driver.Dialect() == dialect.Postgres {
		tq.Unique(false)
	}
	tq.modifiers = append(tq.modifiers, func(s *sql.Selector) {
