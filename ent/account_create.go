...
func (ac *AccountCreate) SetUserID(u uint64) *AccountCreate {
	ac.mutation.SetUserID(u)
	return ac
}

// SetOpenid sets the "openid" field.
func (ac *AccountCreate) SetOpenid(s string) *AccountCreate {
...
func (ac *AccountCreate) SetMethod(s string) *AccountCreate {
...
func (ac *AccountCreate) check() error {
	...
	if _, ok := ac.mutation.Openid(); !ok {
		return &ValidationError{Name: "openid", err: errors.New(`ent: missing required field "Account.openid"`)}
	}
	if v, ok := ac.mutation.Openid(); ok {
	...
	if _, ok := ac.mutation.Method(); !ok {
		return &ValidationError{Name: "method", err: errors.New(`ent: missing required field "Account.method"`)}
	}
