...
func (oc *WalletUseCase) RechargeGoldLeaf(ctx context.Context, userId, goldLeafAmount int32) (*Wallet, error) {
	return oc.walletRepo.RechargeGoldLeaf(ctx, userId, goldLeafAmount)
}
