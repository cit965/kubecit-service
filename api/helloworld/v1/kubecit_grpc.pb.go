...
const (
	...
	Kubecit_MyOrderList_FullMethodName           = "/helloworld.v1.Kubecit/MyOrderList"
...
type KubecitClient interface {
	...
	MyOrderList(ctx context.Context, in *MyOrderRequest, opts ...grpc.CallOption) (*OrderListReply, error)
	//=============================讲师相关================================================
...
func (c *kubecitClient) MyOrderList(ctx context.Context, in *MyOrderRequest, opts ...grpc.CallOption) (*OrderListReply, error) {
	out := new(OrderListReply)
	err := c.cc.Invoke(ctx, Kubecit_MyOrderList_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type KubecitServer interface {
	...
	MyOrderList(context.Context, *MyOrderRequest) (*OrderListReply, error)
	//=============================讲师相关================================================
...
func (UnimplementedKubecitServer) MyOrderList(context.Context, *MyOrderRequest) (*OrderListReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method MyOrderList not implemented")
}
...
func _Kubecit_MyOrderList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(MyOrderRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(KubecitServer).MyOrderList(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Kubecit_MyOrderList_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(KubecitServer).MyOrderList(ctx, req.(*MyOrderRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Kubecit_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Kubecit_MyOrderList_Handler,
		},
		{
